    ...
    <v-layout column wrap>
      ...
      <v-layout>
        <v-flex sm10 md10 lg10 xl10 offset-md1 offset-sm1>
          <v-card>
            <v-list>
              <v-list-tile v-for="brands in carsBrands" :key="brands">
                <v-list-tile-content>
                  <v-list-tile-title v-text="brands"></v-list-tile-title>
                </v-list-tile-content>
              </v-list-tile>
            </v-list>
          </v-card>
      ...
      <v-speed-dial absolute bottom top right>
  ...
  export default {
    ...
    data() {
      return {
        addBrand: false,
        addModel: false,
        carsBrands: this.$store.state.carsBrands,
      };
    },
    methods: {
      /*fetchBrands() {
        this.carsBrands = this.$store.state.carsBrands;
      }*/
    }
  };
